...
export default function StatementTable({
  ...
  // Use exact CellKey indexing so TS knows these keys exist
  ...
  // --- Toggle charge flag + PATCH override ---
  const toggleCharge = (ck: CellKey) => {
    setChargeFlags(prev => {
      ...
      // Ensure your API route handles PATCH at /api/statement
      fetch('/api/statement', {
        method:  'PATCH',
              ...
              <th key={r.id} className="border p-2 text-center">
                <div className="inline-flex items-center space-x-1">
                  ...
                  <button onClick={() => removeColumn(r.id)}
                    ...
                    title="Odebrat položku">&times;</button>
                </div>
              </th>
            ))}
